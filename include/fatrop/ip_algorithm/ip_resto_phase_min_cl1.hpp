...
namespace fatrop
{
    template <typename ProblemType> class IpRestoPhaseMinCl1 : public IpRestoPhaseBase
    {
        ...
        typedef std::shared_ptr<IpInitializerBase> IpInitializerBaseSp;
    ...
    public:
        ...
        // Setters for options
        void set_bound_mult_reset_treshold(Scalar value) { bound_mult_reset_treshold_ = value; }
        void set_constr_mult_reset_treshold(Scalar value) { constr_mult_reset_treshold_ = value; }
        void set_resto_failure_feasibility_treshold(Scalar value)
        {
            resto_failure_feasibility_treshold_ = value;
        }
        void set_constr_viol_tol(Scalar value) { constr_viol_tol_ = value; }

    private:
        IpAlgorithmSp resto_ip_algorithm_;
        IpInitializerBaseSp ip_initializer_;
