...
namespace fatrop
{
    ...
    public:
        ...
        /**
         * @brief Evaluate the full Lagrangian Hessian.
         *
         * @param objective_scale Scale factor for the objective function
         * @param primal_data Pointer to primal variables data
         * @param lam_data Pointer to dual variables data
         * @param RSQrqt_p Pointer to the result matrix
         * @return Status code
         */
        virtual Index full_eval_lag_hess(Scalar objective_scale, const Scalar *primal_data,
                                         const Scalar *lam_data, MAT *RSQrqt_p)
        {
            return 0;
        }

        /**
         * @brief Evaluate the full constraint Jacobian.
         *
         * @param primal_data Pointer to primal variables data
         * @param BAbt_p Pointer to the dynamics constraint Jacobian
         * @param Ggt_p Pointer to the equality constraint Jacobian
         * @param Ggt_ineq_p Pointer to the inequality constraint Jacobian
         * @return Status code
         */
        virtual Index full_eval_constr_jac(const Scalar *primal_data, MAT *BAbt_p, MAT *Ggt_p,
                                           MAT *Ggt_ineq_p)
        {
            return 0;
        }
        ...
        /**
         * @brief Evaluate the full constraint violation.
         *
         * @param primal_data Pointer to primal variables data
         * @param cv_p Pointer to the constraint violation vector
         * @return Status code
         */
        virtual Index full_eval_contr_viol(const Scalar *primal_data, Scalar *cv_p) { return 0; }

        /**
         * @brief Evaluate the full objective gradient.
         *
         * @param objective_scale Scale factor for the objective function
         * @param primal_data Pointer to primal variables data
         * @param grad_p Pointer to the gradient vector
         * @return Status code
         */
        virtual Index full_eval_obj_grad(Scalar objective_scale, const Scalar *primal_data,
                                         Scalar *grad_p)
        {
            return 0;
        }
        ...
        /**
         * @brief Evaluate the full objective function.
         *
         * @param objective_scale Scale factor for the objective function
         * @param primal_data Pointer to primal variables data
         * @param res Pointer to the result (objective function value)
         * @return Status code
         */
        virtual Index full_eval_obj(Scalar objective_scale, const Scalar *primal_data, Scalar *res)
        {
            return 0;
        }
