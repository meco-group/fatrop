...
namespace fatrop
{
    struct NlpDims
    {
        NlpDims(const Index number_of_variables, const Index number_of_eq_constraints, const Index number_of_ineq_constraints)
            : number_of_variables(number_of_variables), number_of_eq_constraints(number_of_eq_constraints), number_of_ineq_constraints(number_of_ineq_constraints) {};
