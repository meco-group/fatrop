...
int main(int argc, char **argv)
{
    ...
    // {
        ...
        std::string so_file = "/home/lander/projects/fatrop_benchmarks/benchmark/testproblem/casadi_codegen.so";
        std::string json_file = "/home/lander/projects/fatrop_benchmarks/benchmark/testproblem/casadi_codegen.json";
        StageOCPApplication app = StageOCPApplicationFactory::from_rockit_interface(so_file, json_file);
