__asm__(" .text\n\t"
" .p2align 4,,15\n\t"
" .def inner_kernel_sgemm_nt_4x4_lib4; .scl 2; .type 32; .endef; inner_kernel_sgemm_nt_4x4_lib4:\n\t"
"\n\t"
"\n\t"
" cmpl $ 0, %r10d\n\t"
" jle 2f\n\t"
...
"\n\t"
" .p2align 4,,15\n\t"
" .def inner_kernel_sgemm_nn_4x4_lib4; .scl 2; .type 32; .endef; inner_kernel_sgemm_nn_4x4_lib4:\n\t"
"\n\t"
"\n\t"
" cmpl $ 0, %r10d\n\t"
" jle 2f\n\t"
...
" .endm\n\t"
" .p2align 4,,15\n\t"
" .globl kernel_sgemm_nt_4x4_lib4; .def kernel_sgemm_nt_4x4_lib4; .scl 2; .type 32; .endef; kernel_sgemm_nt_4x4_lib4:\n\t"
"\n\t"
...
"\n\t"
" .p2align 4,,15\n\t"
" .globl kernel_sgemm_nn_4x4_lib4; .def kernel_sgemm_nn_4x4_lib4; .scl 2; .type 32; .endef; kernel_sgemm_nn_4x4_lib4:\n\t"
"\n\t"
" subq $256, %rsp; movq %rbx, (%rsp); movq %rbp, 8(%rsp); movq %r12, 16(%rsp); movq %r13, 24(%rsp); movq %r14, 32(%rsp); movq %r15, 40(%rsp); movq %rdi, 48(%rsp); movq %rsi, 56(%rsp); movups %xmm6, 64(%rsp); movups %xmm7, 80(%rsp); movups %xmm8, 96(%rsp); movups %xmm9, 112(%rsp); movups %xmm10, 128(%rsp); movups %xmm11, 144(%rsp); movups %xmm12, 160(%rsp); movups %xmm13, 176(%rsp); movups %xmm14, 192(%rsp); movups %xmm15, 208(%rsp);\n\t"
"\n\t"
"\n\t"
