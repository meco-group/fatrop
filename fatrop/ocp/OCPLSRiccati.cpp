...
OCPLSRiccati::OCPLSRiccati(const OCPDims &dims, const shared_ptr<FatropOptions> &options, const shared_ptr<FatropPrinter> &printer) : Ppt(dims.nx + 1, dims.nx, dims.K),
                                                                                                                                      ...
                                                                                                                                      AL(vector<int>(1, maxel(dims.nu + dims.nx + 1)), vector<int>(1, maxel(dims.nx)), 1),
                                                                                                                                      RSQrqt_tilde(dims.nu + dims.nx + 1, dims.nx + dims.nu, dims.K), // TODO, only save first rho rows (can never exceed nu)
                                                                                                                                      Ggt_stripe(vector<int>(1, maxel(dims.nu + dims.nx + 1)), vector<int>(1, maxel(dims.nx + dims.nu)), 1),
                                                                                                                                      Ggt_tilde(dims.nu + dims.nx + 1, dims.nx + dims.nu, dims.K), // TODO, only save first rho rows (can never exceed nu)
                                                                                                                                      GgLt(vector<int>(1, maxel(dims.nu + dims.nx + 1)), vector<int>(1, maxel(dims.nu + dims.nx)), 1),
                                                                                                                                      RSQrqt_hat(vector<int>(1, maxel(dims.nu + dims.nx + 1)), vector<int>(1, maxel(dims.nx + dims.nu)), 1),
                                                                                                                                      Llt(dims.nu + dims.nx + 1, dims.nu, dims.K),
                                                                                                                                      Llt_shift(vector<int>(1, maxel(dims.nu + dims.nx + 1)), vector<int>(1, maxel(dims.nu)), 1),
                                                                                                                                      ...
                                                                                                                                      Ggt_ineq_temp(vector<int>(1, maxel(dims.nu + dims.nx) + 1), vector<int>(1, maxel(dims.ng_ineq)), 1),
                                                                                                                                      ...
                                                                                                                                      v_Hh(dims.nx, dims.K),
                                                                                                                                      v_AL(vector<int>(1, maxel(dims.nx)), 1),
                                                                                                                                      v_RSQrqt_tilde(dims.nu + dims.nx, dims.K),
                                                                                                                                      v_Ggt_stripe(vector<int>(1, maxel(dims.nx + dims.nu)), 1),
                                                                                                                                      v_Ggt_tilde(dims.nu + dims.nx, dims.K),
                                                                                                                                      v_GgLt(vector<int>(1, maxel(dims.nu + dims.nx)), 1),
                                                                                                                                      v_RSQrqt_hat(vector<int>(1, maxel(dims.nx + dims.nu)), 1),
                                                                                                                                      v_Llt(dims.nu + dims.nx, dims.K),
                                                                                                                                      v_Llt_shift(vector<int>(1, maxel(dims.nu)), 1),
                                                                                                                                      ...
                                                                                                                                      v_Ggt_ineq_temp(vector<int>(1, maxel(dims.ng_ineq)), 1),
