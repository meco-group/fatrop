int get_horizon_lenght();
int get_nxk(const int k);
int get_initial_xk(double *xk);
int get_initial_uk(double *uk);
int get_nuk(const int k);
int get_ngk(const int k);
int get_n_stage_params_k(const int k);
int get_default_stage_paramsk(double *stage_params);
int get_n_global_parmas();
int get_default_global_params(double *global_params);
int get_ng_ineq_k(const int k);
int get_lower_boundsk(double *lower_bounds);
int get_upper_boundsk(double *upper_bounds);
...
// typedef int (*intf_get_initial_xk)(double *xk);

// typedef int (*intf_get_initial_uk)(double *uk);
...
// typedef int (*intf_get_default_stage_paramsk)(double *stage_params);
...
// typedef int (*intf_get_lower_boundsk)(double *lower_bounds);

// typedef int (*intf_get_upper_boundsk)(double *upper_bounds);
