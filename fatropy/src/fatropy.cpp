...
PYBIND11_MODULE(_fatropy, m)
{
    ...
    py::class_<fatrop::StageOCPApplication>(m, "StageOCPApplication")
        ...
        .def("set_option", &fatrop::StageOCPApplication::set_option<bool>)
        .def("set_option", &fatrop::StageOCPApplication::set_option<int>)
        .def("set_option", &fatrop::StageOCPApplication::set_option<double>)
        .def("set_option", &fatrop::StageOCPApplication::set_option<const std::string&>)
