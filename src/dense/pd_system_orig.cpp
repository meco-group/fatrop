...
LinearSystem<PdSystemType<DenseType>>::LinearSystem(
...
Index LinearSystem<PdSystemType<DenseType>>::m(const ProblemInfo<DenseType> &info)
{
    return info.number_of_tangent_variables + 3 * info.number_of_slack_variables +
           info.number_of_eq_constraints;
}

void LinearSystem<PdSystemType<DenseType>>::get_rhs(VecRealView &out)
{
...
void LinearSystem<PdSystemType<DenseType>>::set_rhs(const VecRealView &in)
{
...
void LinearSystem<PdSystemType<DenseType>>::apply_on_right(const VecRealView &x, Scalar alpha,
                                                           const VecRealView &y,
                                                           VecRealView &out)
{
