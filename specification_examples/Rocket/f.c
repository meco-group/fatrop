...
static const casadi_int casadi_s12[3] = {10, 0, 0};
...
/* RSQrqtF:(i0,i1[2],i2[9],i3[9],i4[4],i5[0],i6[0],i7[0])->(o0[10x9]) */
...
/* GgineqFt:(i0[9],i1[0],i2[0])->(o0[10x0]) */
