...
static const casadi_int casadi_s8[3] = {3, 0, 0};
...
/* RSQrqtF:(i0,i1[2],i2[2],i3[2],i4[0],i5[2],i6[0],i7[0])->(o0[3x2]) */
...
/* GgtF:(i0[2],i1[2],i2[0],i3[0])->(o0[3x0]) */
...
/* GgineqFt:(i0[2],i1[0],i2[0])->(o0[3x2]) */
