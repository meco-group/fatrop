...
int main()
{
    ...
    for (int i = 0; i < N; i++)
    {
        ocplsriccati->computeSD(&ocpalg.ocpkktmemory_, 0.0, 0.0, 0.0, 0.0, ux[0], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0]);
    }
    ...
    ocplssparse->computeSD(&ocpalg.ocpkktmemory_, 0.0, 0.0,0.0,0.0, ux[1], lags[1], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0], lags[0]);
