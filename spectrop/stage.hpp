...
namespace fatrop
{
    namespace spectrop
    {
        ...
        public:
            ...
            const std::vector<cs::MX> get_states(bool include_automatics = true) const;
            const uo_map_mx<std::vector<cs::MX>> &get_state_syms() const;
            const std::vector<cs::MX> get_controls(bool include_automatics = true) const;
            const uo_map_mx<std::vector<cs::MX>> &get_control_syms() const;
            const std::vector<cs::MX> &get_automatics() const;
            const std::vector<cs::MX> get_automatics_states() const;
            const std::vector<cs::MX> get_automatics_controls() const;
            const uo_map_mx<std::vector<cs::MX>> &get_automatic_syms() const;
        ...
        private:
            ...
            void register_automatic(const cs::MX &automatic);
            void register_control_parameter(const cs::MX &control_parameter);
            void get_automatics(std::vector<cs::MX>& states, std::vector<cs::MX>& controls) const;
            const int K_;
            ...
            std::vector<cs::MX> automatics_;
            uo_set_mx automatics_set_;
            uo_map_mx<std::vector<cs::MX>> control_syms_;
            uo_map_mx<std::vector<cs::MX>> automatic_syms_;
